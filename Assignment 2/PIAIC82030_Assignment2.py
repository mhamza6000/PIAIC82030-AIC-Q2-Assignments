...
def function7():
    ...
    return np.zeros_like(x,dtype=x.dtype)#write your code here
...
def function8():
    ...
    x = np.full((2,5), 6, dtype=np.uint8)#write your code here
...
def function18():
    ...
    x = len(np.where(np.isin(piaic,students))[0])     # Write you code Here
    return x
